        ...
        <div className="md:block hidden">
          ...
          <div>
            ...
            <div className="flex mx-[5%] scale-[95%]">
              <div className="mx-4">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525541/34_1_prxot9.png" />
                <p className="uppercase text-left pt-3">Career Guidance App Design</p>
              </div>
              <div className="mx-4">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525530/Map_1_yyuwru.png" />
                <p className="text-left pt-3">
                Indian Maps App Design
                </p>
              </div>
              <div className="mx-4 ">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525542/24_1_abt9hz.png" />
                <p className="uppercase text-left pt-3">Redesign of Whatsapp </p>
              </div>
            </div>
          </div>
          {/* wEB dESIGN */}
          <div>
            ...
            <div className="flex mx-[5%] scale-[95%]">
              ...
              <div className="mx-4">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718540274/image_1_eo3lkk.png" />
                <p className="text-left pt-3">
                Corporate Excellence Summit
                </p>
              </div>
              <div className="mx-4 ">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525534/Home_Landing_Page_1_cma0cv.png  " />
                <p className="uppercase text-left pt-3">Festival of Colors </p>
              </div>
            </div>
          </div>
          {/* pRODUCT DESIGN */}
          <div>
            ...
            <div className="flex mx-[5%] scale-[95%]">
              <div className="mx-4">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525530/Image_tqqoeg.png" />
                <p className="uppercase text-left pt-3">Vinta Bag</p>
              </div>
              <div className="mx-4">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525533/Image_1_hbuzrj.png" />
                <p className="text-left pt-3">
                Brand Storytelling
                </p>
              </div>
              <div className="mx-4 ">
                <img src="https://res.cloudinary.com/dyf6jb0yu/image/upload/v1718525533/Image_2_jkmpf8.png" />
                <p className="uppercase text-left pt-3">Culinary Delights </p>
              </div>
            </div>
          </div>
